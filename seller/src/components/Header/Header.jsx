...
function Header() {
  ...
  const sellerLink = !isAuthenticated ? '/seller/login' : hasSellerAccount ? (isSellerReady ? '/seller/dashboard' : '/seller/onboarding/welcome') : '/seller/register'
      ...
      <div className="header-top">
        <div className="container header-top-inner">
          <div className="header-top-left">
            <Link to={sellerLink}>Kênh Người Bán</Link>
            <span>Kết nối</span>
